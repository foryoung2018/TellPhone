...
public class HtcViewPagerCombineTabbar extends CommonDemoActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle = getResources().getString(R.string.tabbar_demo_title);
    ...
    public class MyAdapter extends HtcPagerAdapter implements HtcViewPager.OnPageChangeListener {
        public MyAdapter() {
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            return mTitle + nf.format(position);
        }
