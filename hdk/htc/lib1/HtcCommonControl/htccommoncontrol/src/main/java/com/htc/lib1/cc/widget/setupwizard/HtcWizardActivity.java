...
public abstract class HtcWizardActivity extends Activity implements
    ...
    private void initUI() {
        ...
        TypedArray a = obtainStyledAttributes(null, R.styleable.HtcSetupWizard, R.attr
            .htcWizardActivityStyle, R.style.HtcWizardActivityStyle);
        final int wizardLayoutId = a.getResourceId(R.styleable.HtcSetupWizard_android_layout, R
            .layout.wizard_activity);
        final int background = a.getResourceId(R.styleable.HtcSetupWizard_android_background, R
            .color.dark_primaryfont_color);
        final int tipsBackground = a.getResourceId(R.styleable
            .HtcSetupWizard_android_listDivider, R.drawable.section_divider_top);
        final int tipsStyle = a.getResourceId(R.styleable.HtcSetupWizard_android_textAppearance, R
            .style.fixed_list_body_primary_s);
        a.recycle();
        ...
        mTip.setBackground(getResources().getDrawable(tipsBackground));
        mTip.setTextAppearance(this, tipsStyle);
        mBaseLayout = (ViewGroup) mContentView
                .findViewById(com.htc.lib1.cc.R.id.base_layout);
        mBaseLayout.setBackground(getResources().getDrawable(background));
