...
public class HtcRimButton extends HtcIconButton {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (null != mBkgDrawable) {
                setBackground(mBkgDrawable);
        ...
        setTextAppearance(context, mDefTextAppearanceId);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mCenterX = (mCanvasRect.left + mCanvasRect.right) / 2;
        mCenterY = (mCanvasRect.top + mCanvasRect.bottom) / 2;
    ...
    public void setButtonBackgroundDrawable(Drawable background_outer, Drawable background_press, Drawable background) {
        if (background_press != null && background_press != null && background != null) {
            ...
            if (mBackground == null) mBackground = new BackgroundDrawable(getContext(), mDefRestDrawable);
    ...
    public void useSelectorWhenPressed(boolean enabled) {
        ...
        if (tmp instanceof BackgroundDrawable) {
            ...
            mBackground = new BackgroundDrawable(getContext(), mDefRestDrawable);
