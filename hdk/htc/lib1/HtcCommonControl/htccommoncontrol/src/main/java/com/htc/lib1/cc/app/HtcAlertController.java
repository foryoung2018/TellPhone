...
public class HtcAlertController {
    ...
    public HtcAlertController(Context context, DialogInterface di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, R.styleable.AlertDialog, R.attr.htcAlertDialogStyle, R.style.AlertDialog);
        mAlertDialogLayout = a.getResourceId(R.styleable.AlertDialog_android_layout_toStartOf, R.layout.alert_dialog);
        mMultiChoiceItemLayout = a.getResourceId(R.styleable.AlertDialog_android_listChoiceIndicatorMultiple, R.layout.dialog_listitem_check);
        mSingleChoiceItemLayout = a.getResourceId(R.styleable.AlertDialog_android_listChoiceIndicatorSingle, R.layout.dialog_listitem_radio);
        mListItemLayout = a.getResourceId(R.styleable.AlertDialog_android_textAppearanceListItem, R.layout.dialog_listitem);
        mListLayout = a.getResourceId(R.styleable.AlertDialog_android_absListViewStyle, R.layout.select_dialog);
        mCheckPanelLayout = a.getResourceId(R.styleable.AlertDialog_android_checkboxStyle, R.layout.dialog_checkpanel);

        mIsAutoMotive = a.getBoolean(R.styleable.AlertDialog_android_isDefault, false);
        a.recycle();
     ...
     * @hide
     */
    public void setCheckBox(CharSequence checkBoxLabel, boolean checkBoxDefault, CompoundButton.OnCheckedChangeListener checkBoxListener, boolean checkBoxEnabled) {
    ...
    private void setupView() {
        ...
        TypedArray a = mContext.obtainStyledAttributes(
                null, R.styleable.AlertDialog, R.attr.htcAlertDialogStyle, 0);
    ...
    private void setupContent(LinearLayout contentPanel) {
        ...
        if (!TextUtils.isEmpty(mCheckBoxLabel)) {
            ...
            parentPanel.addView(mCheckBoxPanel, index, new LinearLayout.LayoutParams(MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        }
    }
...
//        }
    ...
    * @hide
     * @deprecated
     * The method in Sense8 is failure
    */
    ...
    public static class AlertParams {
        ...
        public int mSingleTextAlignment;
        public boolean mSetSingle = false;
                ...
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                        ...
                        public View getView(int position, View convertView, ViewGroup parent) {
                            ...
                            if (mSetSingle) {
                                text.setSingleTextAlignment(mSingleTextAlignment);
                            }
