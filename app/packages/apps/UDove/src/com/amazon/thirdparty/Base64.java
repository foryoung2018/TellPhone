...
public class Base64 {
	/* For HTC log */
	private final static String TAG = Base64.class.getSimpleName();
	...
	public static String encodeObject(java.io.Serializable serializableObject,
		...
		try {
			...
			try {
				if(oos != null)    //[REX] CQG issue, Avoiding null pointer exception, 20120925.
					oos.close();
			} catch (Exception e) {
				Log.e(TAG, "", e); // [REX] HTC log
			}
			try {
				if(gzos != null)  //[REX] CQG issue, Avoiding null pointer exception, 20120925.
				gzos.close();
			} catch (Exception e) {
				Log.e(TAG, "", e); // [REX] HTC log
			}
		...
		//[REX] CQG issue, #13216657, 2012/10/23, begin
		String returnValue = null;
		try {
			if(baos != null)
				returnValue =  new String(baos.toByteArray(), PREFERRED_ENCODING);
		} // end try
		...
		return  returnValue;
		//[REX] CQG issue, #13216657, 2012/10/23, end
	} // end encode
	...
	public static String encodeBytes(byte[] source, int off, int len,
		...
		if (gzip == GZIP) {
			...
			// Return value according to relevant encoding.
			//[REX] CQG issue, #13216661, 2012/10/23, begin
			String returnValue = null;
			try {
				if(baos != null)
					returnValue = new String(baos.toByteArray(), PREFERRED_ENCODING); 
			 ...
			 return returnValue;
			//[REX] CQG issue, #13216661, 2012/10/23, end
		} // end if: compress
		...
		if (bytes != null && bytes.length >= 4) {
			...
			if (java.util.zip.GZIPInputStream.GZIP_MAGIC == head) {
				...
				try {
					...
					try {
						if(gzis != null)  //[REX] CQG issue, Avoiding null pointer exception, 20120925.
							gzis.close();
					} catch (Exception e) {
						Log.e(TAG, "", e); // [REX] HTC log
					}
	...
	public static Object decodeToObject(String encodedObject) {
		...
		try {
			...
			try {
				if(ois != null)   //[REX] CQG issue, Avoiding null pointer exception, 20120925.
					ois.close();
			} catch (Exception e) {
				Log.e(TAG, "", e); // [REX] HTC log
			}
	...
	public static boolean encodeToFile(byte[] dataToEncode, String filename) {
		...
		java.io.FileOutputStream fos = null;   //[REX] CQG issue, Add input stream instance for avoiding resource leak, 20120925.
		try {
		...
		/*	bos = new Base64.OutputStream(
			...
			try {
				if(bos != null)             //[REX] CQG issue, Avoiding null pointer exception, 20120925.
					bos.close();             
			} catch (Exception e) {
				Log.e(TAG, "", e); // [REX] HTC log
			}
	...
	public static byte[] decodeFromFile(String filename) {
		...
		java.io.FileInputStream fis = null;   //[REX] CQG issue, Add input stream instance for avoiding resource leak, 20120925.
		java.io.BufferedInputStream bufferIs = null;
		try {
			...
			bufferIs = new java.io.BufferedInputStream(fis);
			bis = new Base64.InputStream(bufferIs, Base64.DECODE);
		/*	bis = new Base64.InputStream(new java.io.BufferedInputStream(
			...
			try {
				if(bis != null) //[REX] CQG issue, Avoiding null pointer exception, 20120925.
					bis.close();          
			} catch (Exception e) {
				Log.e(TAG, "", e); // [REX] HTC log
			}
	...
	public static String encodeFromFile(String filename) {
		...
		try {
			...
			fis = new java.io.FileInputStream(file);
			bufferIs = new java.io.BufferedInputStream(fis);
			bis = new Base64.InputStream(bufferIs, Base64.ENCODE);
		/*	bis = new Base64.InputStream(new java.io.BufferedInputStream(
