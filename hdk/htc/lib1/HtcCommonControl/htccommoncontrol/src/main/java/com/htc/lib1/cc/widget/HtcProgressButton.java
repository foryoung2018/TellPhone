...
public class HtcProgressButton extends HtcImageButton {
    ...
    private void init(Context context) {
        final int defStyleRes = HtcButtonUtil.isDarkMode(getBackgroundMode()) ? R.style.HtcProgressButton : R.style.HtcProgressButton_Light;
        TypedArray a = context.obtainStyledAttributes(null, R.styleable.HtcProgressButton, R.attr.htcProgressButtonStyle, defStyleRes);
        mOverlayColor = a.getColor(R.styleable.HtcProgressButton_overlay_color, HtcButtonUtil.getCategoryColor(context, null));
        mRailColor = a.getColor(R.styleable.HtcProgressButton_android_itemBackground, 0xFF000000);
        final float railAlpha = a.getFloat(R.styleable.HtcProgressButton_android_itemIconDisabledAlpha, 0.6f);
        mRailAlpha = (int) (0xFF * railAlpha);
        a.recycle();
