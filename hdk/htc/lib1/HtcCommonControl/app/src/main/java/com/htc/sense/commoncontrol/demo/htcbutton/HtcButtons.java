...
public class HtcButtons extends CommonDemoActivityBase implements OnItemClickListener, PopupBubbleWindow.OnDismissListener {
    ...
    private void applyOvlayIcon() {
        final int[] buttonId = new int[]{R.id.icon_light_2, R.id.icon_light_3, R.id.icon_light_4, R.id.icon_light_disable, R.id.rim_light_2, R.id.rim_light_3, R.id.rim_light_4,
                R.id.rim_light_disable, R.id.icon_coloron, R.id.rim_coloron, R.id.icon_stayinpress, R.id.rim_stayinpress, R.id.icon_noanim, R.id.rim_noanim, R.id.icon_popup, R.id.rim_popup};
        Button button = null;
        for (int i = 0; i < buttonId.length; i++) {
            ...
            button.setCompoundDrawablesRelativeWithIntrinsicBounds(null, d, null, null);
        }
    }
