...
public class HtcGridItem extends HtcGridItemBase {
    ...
    @ExportedProperty(category = "CommonControl")
    private int mPrimaryTextStyleResId = 0;

    @ExportedProperty(category = "CommonControl")
    private int mSecondaryTextStyleResId = 0;
    ...
    public HtcGridItem(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.htcGridItemStyle);
    }
    ...
    public HtcGridItem(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HtcGridItem, defStyle, R.style.HtcGridItemStyle);
        mTextHorizontalMargin = a.getDimensionPixelOffset(R.styleable.HtcGridItem_android_insetLeft, getResources().getDimensionPixelOffset(R.dimen.margin_m));
        mPrimaryTextMarginTop = a.getDimensionPixelOffset(R.styleable.HtcGridItem_android_insetTop, getResources().getDimensionPixelOffset(R.dimen.spacing));
        mTextMarginBottom = a.getDimensionPixelOffset(R.styleable.HtcGridItem_android_insetBottom, getResources().getDimensionPixelOffset(R.dimen.margin_l));
        mPrimaryTextStyleResId = a.getResourceId(R.styleable.HtcGridItem_android_textAppearanceLarge, R.style.list_primary_xxs);
        mSecondaryTextStyleResId = a.getResourceId(R.styleable.HtcGridItem_android_textAppearanceSmall, R.style.list_secondary_xs);
        a.recycle();
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int secondaryTextHeight = mSecondaryText != null
                ...
                : 0;
        int totalHeight = mImageView.getMeasuredHeight() + mPrimaryTextMarginTop
                + primaryTextHeight + secondaryTextHeight + mTextMarginBottom;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int primaryTextTop = mImageView.getBottom() + mPrimaryTextMarginTop;
...
//        }
    ...
    void applyGenericFontStyle() {
        mPrimaryText.setTextAppearance(getContext(), mPrimaryTextStyleResId);
        if (mSecondaryText != null) {
            mSecondaryText.setTextAppearance(getContext(), mSecondaryTextStyleResId);
        }
    }
