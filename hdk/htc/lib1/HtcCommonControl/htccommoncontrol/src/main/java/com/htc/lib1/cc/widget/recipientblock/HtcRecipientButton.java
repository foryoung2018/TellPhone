...
public class HtcRecipientButton extends LinearLayout {
    ...
    protected void setStyle(int style) {
        ...
        case ACTION_BAR_BUTTON_STYLE:
            ...
            TypedArray a = getContext().obtainStyledAttributes(null, R.styleable.RecipientBlock, R.attr
                .htcRecipientBlock, R.style.HtcRecipientBlockStyle);
            final int rimButtonStyleId = a.getResourceId(R.styleable
                .RecipientBlock_android_buttonStyle, R.style.list_secondary_m);
            a.recycle();
            ...
            mRimButton.setTextAppearance(getContext(), rimButtonStyleId);
