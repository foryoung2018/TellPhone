...
class HtcListItem2TextComponent extends FrameLayout implements IHtcListItemComponent {
    ...
    protected int mMode = MODE_UNKNOWN_LIST;
    ...
    /**
     * The text mode is used for get style from theme.
     */
    public final static int MODE_UNKNOWN_LIST = -1;
    ...
    /**
     * Be used its descendants constructor has 4 parameters invoke.
     *
     */
    protected HtcListItem2TextComponent(Context context, AttributeSet attrs, int defStyle, int mode) {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (!isUseDesiredHeight) {
            ...
            if (mText[0].getVisibility() != GONE && mText[1].getVisibility() != GONE) {
                // topGap , middle and bottomGap must be honored.
                totalHeight += mHtcListItemManager.getDesiredTopGap(mItemMode)
                        + mHtcListItemManager.getDesiredMiddleGap(mItemMode)
                ...
                // topGap , middle and bottomGap should be honored.
                totalHeight += mHtcListItemManager.getDesiredTopGap(mItemMode)
                        + mHtcListItemManager.getDesiredMiddleGap(mItemMode)
                        + mHtcListItemManager.getDesiredBottomGap(mItemMode);
            } else {
