...
public class HtcListItem7Badges1LineBottomStamp extends View implements IHtcListItemComponent {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int stampTextStyleId = a.getResourceId(R.styleable.HtcListItemAppearance_android_textAppearanceMedium,
                R.style.fixed_list_secondary);
        int bubbleTextStyleId = a.getResourceId(R.styleable.HtcListItemAppearance_android_textAppearanceMediumInverse,
                R.style.fixed_notification_info_m);
        a.recycle();
        HtcResUtil.setTextAppearance(context, stampTextStyleId,
                mStampPaint);
        mStampPaint.setTextAlign(Paint.Align.RIGHT);
        mStampPaint.setAntiAlias(true);

        HtcResUtil.setTextAppearance(context,
                bubbleTextStyleId, mBubblePaint);
    ...
    private HtcListItem7Badges1LineBottomStamp(Context context, AttributeSet attrs, int defStyle, int mode) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getBadgeState(BUBBLE_COUNT_INDEX)) {
            ...
            if (bBadgeVirticalCenter)
                ...
                textBaseY = mHtcListItemManager.getPrimaryBaseLine(mItemMode) - mBubbleFontMetrics.bottom;
