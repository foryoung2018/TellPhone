...
public class HtcListActivity extends CommonDemoActivityBase {
    ...
    protected boolean mAddMenuShowKeep=false;
    ...
    private static final String KEEP_MEDIUM_HEIGHT_KEY = "show_keepmediumheight_key";
    public boolean mEnableAutomotive = false;
    public boolean mShowListItem = false;
    public boolean mShowKeep = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mShowKeep = savedInstanceState.getBoolean(KEEP_MEDIUM_HEIGHT_KEY);
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem itemShowKeep = menu.findItem(R.id.keep);
        ...
        if (mAddMenuShowKeep) {
            itemShowKeep.setChecked(mShowKeep);
        } else {
            itemShowKeep.setVisible(false);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.listitem:
                ...
                return true;
            case R.id.keep:
                item.setChecked(mShowKeep = !mShowKeep);
                recreate();
                return true;
            default:
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(KEEP_MEDIUM_HEIGHT_KEY, mShowKeep);
    }
