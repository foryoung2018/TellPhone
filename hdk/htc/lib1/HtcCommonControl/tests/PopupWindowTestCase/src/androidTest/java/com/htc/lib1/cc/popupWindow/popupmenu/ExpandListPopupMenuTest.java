package com.htc.lib1.cc.popupWindow.popupmenu;
...
import com.htc.popupWindow.aut.popupmenu.ExpandableListPopupMenuDemo;
...
public class ExpandListPopupMenuTest extends HtcActivityTestCaseBase {
    ...
    private View[] getWindowRootView(String btnText, boolean isExpand) {
        ...
        if(EXPANDABLE_POPUP_MENU.equals(btnText)){
            btn = mActivity.findViewById(com.htc.popupWindow.aut.R.id.top_btn);
        }else if(WRAPPER_EXPANDABLE.equals(btnText)){
            btn = mActivity.findViewById(com.htc.popupWindow.aut.R.id.btn);
        }
        if(null == btn){
            return null;
        }
