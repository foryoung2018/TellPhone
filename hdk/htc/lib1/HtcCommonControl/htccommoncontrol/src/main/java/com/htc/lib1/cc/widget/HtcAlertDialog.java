...
public class HtcAlertDialog extends Dialog implements DialogInterface {
    ...
    */
    ...
    public static class Builder {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setCheckBox(CharSequence checkBoxLabel, boolean checkBoxDefault, CompoundButton.OnCheckedChangeListener checkBoxListener, boolean checkBoxEnabled) {
        ...
        */
         ...
         *@return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setSingleTextAlignment(int textAlignment) {
            P.mSingleTextAlignment = textAlignment;
            P.mSetSingle = true;
            return this;
        }
