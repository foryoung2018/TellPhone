...
public class ActionBarDemoApActivity extends CommonDemoActivityBase {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    ...
                    case R.id.radioButton4:
                        mActionBarContainer.setUpdatingViewText(ActionBarContainer.UPDATING_MODE_PULLDOWN, R.string.pullDown_update_secondary);
                        mActionBarContainer.setUpdatingViewText(ActionBarContainer.UPDATING_MODE_PULLDOWN_TITLE, R.string.pullDown_title);
                        mActionBarContainer.setUpdatingState(ActionBarContainer.UPDATING_MODE_PULLDOWN);
                        break;

                    case R.id.radioButton5:
                        mActionBarContainer.setUpdatingViewText(ActionBarContainer.UPDATING_MODE_UPDATING, R.string.pullDown_update);
                        mActionBarContainer.setUpdatingState(ActionBarContainer.UPDATING_MODE_UPDATING);
                        break;

                    case R.id.radioButton8:
                        mActionBarContainer.setUpdatingViewText(3, R.string.actionbar_text_primary);
                        mActionBarContainer.setUpdatingState(ActionBarContainer.UPDATING_MODE_UPDATING_WITH_TITLE);
                        break;

                    case R.id.radioButton9:
                        mActionBarContainer.setUpdatingViewText(4, R.string.dropdown_primary);
    ...
    private void setBackupViewAndPhoto() {
        ...
        ActionBar.LayoutParams lp = (ActionBar.LayoutParams) mActionBarQuickContactLeft.getLayoutParams();
        lp.setMarginStart(cb.isChecked() ? 0 : HtcResUtil.getM2(this));
        mActionBarQuickContactLeft.setLayoutParams(lp);
    }
