...
public class AlertDialogDemo extends DialogActivityBase implements
        ...
        switch (id) {
            ...
            case DIALOG_CHECK_MESSAGE:
                ...
                final HtcAlertDialog.Builder chkMsgBuilder = new HtcAlertDialog.Builder(
                        ...
                        .setCheckBox(getString(R.string.dont_ask), false, (CompoundButton.OnCheckedChangeListener)null,
                                true)
                        .setPositiveButton(va_ok, new OnClickListener() {
            ...
            case DIALOG_AUTO_CHECKBOX:
                final HtcAlertDialog.Builder chkAutoBuilder = new HtcAlertDialog.Builder(
                        ...
                        .setCheckBox(getString(R.string.dont_ask), true, (CompoundButton.OnCheckedChangeListener)null, true)
                        .setPositiveButton(R.string.alert_dialog_ok,
                                new OnClickListener() {
    ...
    public void improveCoverage() {
        ...
        dialog.setButton3("Button3", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            }
        });
        ...
        CustomDialog otherDialog = new CustomDialog(this, R.style.HtcDeviceDefault);
