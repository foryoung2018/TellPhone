...
public class HtcListItemSerialNumber extends HtcListItemImageComponent implements
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
            R.styleable.HtcListItemSerialNumber, R.attr.htcListItemSerialNumberStyle, R.style.HtcListItemSerialNumber);
        mDarkModeBgResId = a.getResourceId(
            R.styleable.HtcListItemSerialNumber_android_background, R.drawable.common_photo_frame);
        int fontStyleId = a.getResourceId(R.styleable
            .HtcListItemSerialNumber_android_textAppearance, R.style.list_body_secondary_xl);
        a.recycle();
        HtcResUtil.setTextAppearance(context, fontStyleId, mNumberPaint);
        setDarkMode(HtcListItemManager.getInstance(context).getCurrentThemeType() == HtcCommonUtil.THEME_DARK);
    }
    ...
    public void setDarkMode(boolean isDarkModeEnabled) {
        if (mIsDarkModeEnabled != isDarkModeEnabled) {
            ...
            // DarkMode FontColor is a temporary design to avoid UI issue
            int color = getContext().getResources().getColor(mIsDarkModeEnabled ?
                R.color.dark_primaryfont_color : R.color.light_separatorfont_color);
