...
public class ExpandableListPopupMenuDemo extends CommonDemoActivityBase {
    ...
    private class ActionAdapter extends BaseAdapter {
        ...
        private String[] ItemStrings = getResources().getStringArray(R.array.popup_menu_expandable_listitem);
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        // groups[i].
        private String[] groups = getResources().getStringArray(R.array.popup_menu_expandable_groups);

        private String[][] children = CommonUtil.parseDimensionalArray(ExpandableListPopupMenuDemo.this, R.array.popup_menu_expandable_children);
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            item.setBackgroundColor(((HtcExpandableListView) parent).getExpandableItemBackgroundColor());
            return item;
            // 20120531
        }
