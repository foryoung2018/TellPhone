...
public class DemoActivity extends CommonDemoActivityBase2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mLaunchList) {
            ...
            FloatingActionButton fab = (FloatingActionButton) inflater.inflate(R.layout.floating_action_button, fl, false);
            CommonUtil.applyHtcThemeColor(this,fab);
            fab.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    initSkinArray();
                    Dialog shikDailog = new HtcAlertDialog.Builder(view.getContext())
                            .setTitle("Change Skin Dialog")
                            .setItems(mSkinArray,
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            String resName = mSkinArray[which].toString();
    ...
    private CharSequence[] mSkinArray = null;
    ...
    private void initSkinList() {
        ...
        mSkinList.add(getResources().getResourceEntryName(R.style.HtcDeviceDefault_Dark));
        mSkinList.add(getResources().getResourceEntryName(R.style.CarTheme));
    }
    private void initSkinArray() {
        mSkinArray = getResources().getStringArray(R.array.theme_category);
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mLaunchList) {
            ...
            MenuItem headerItem = menu.findItem(R.id.header_id);
            if (mHeaderMode == CommonUtil.MODE_HEADER_TEXTURE) {
                headerItem.setTitle("Enable Header Theme Color");
            } else {
                headerItem.setTitle("Enable Header Theme Texture");
            }
        }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.header_id:
                if (mHeaderMode == CommonUtil.MODE_HEADER_TEXTURE) {
                    mHeaderMode = CommonUtil.MODE_HEADER_COLOR;
                } else {
                    mHeaderMode = CommonUtil.MODE_HEADER_TEXTURE;
                }
                recreate();
                break;
