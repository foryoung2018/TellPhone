 ...
 */
    ...
    @ExportedProperty(category = "CommonControl", resolveId = true)
    private int mDragItemBackgroundResId =0;
    /**
    ...
    public HtcReorderListView(Context context, AttributeSet attrs) {
        ...
        imageDragger = (Drawable) a.getDrawable(R.styleable.HtcReorderListView_android_drawable);
        mListItemMargin = res.getDimensionPixelOffset(a.getResourceId(R.styleable.HtcReorderListView_android_insetLeft, R.dimen.margin_l));
        mDragViewWithFrame = LayoutInflater.from(context).inflate(a.getResourceId(R.styleable.HtcReorderListView_android_layout, R.layout.htc_reorder_list_drag_item), null);
        mDividerDrawable = res.getDrawable(a.getResourceId(R.styleable.HtcReorderListView_android_childDivider, R.drawable.common_list_divider));
        mDragItemBackgroundResId = a.getResourceId(R.styleable.HtcReorderListView_android_itemBackground, R.color.ap_background_color);
        Drawable rearrange = res.getDrawable(a.getResourceId(R.styleable.HtcReorderListView_android_panelBackground, R.drawable.common_rearrange_frame));
        a.recycle();
...
//            final Rect listPadding = mListPadding;
    ...
    private void startDragging(Bitmap bm, int y) {
        ...
        mDragItemCache.setBackgroundResource(mDragItemBackgroundResId);
