...
final class HtcListItemUtil {
    ...
    static void setContextForMargins(Context c, int itemMode) {
        ...
        TypedArray a = HtcListItemManager.obtainStyleIdSet(itemMode, 0, 0, c, null);
        ...
        int primaryTextDimen = a.getResourceId(R.styleable.HtcListItemAppearance_android_textColorPrimaryInverse,
                com.htc.lib1.cc.R.dimen.list_primary_m);
        int secondaryTextDimen = a.getResourceId(R.styleable.HtcListItemAppearance_android_textColorSecondaryInverse,
                com.htc.lib1.cc.R.dimen.list_secondary_m);
        a.recycle();

        int pfont = res.getDimensionPixelSize(primaryTextDimen);
        ...
        sPrimaryTextSize[itemMode] = res
                .getDimensionPixelSize(primaryTextDimen);
        sSecondaryTextSize[itemMode] = res
                .getDimensionPixelSize(secondaryTextDimen);
        updateTextHeight(c, primaryTextStyleId, sPrimaryTextBaseline,
                sPrimaryTextViewHeight, itemMode);
        updateTextHeight(c, secondaryTextStyleId, sSecondaryTextBaseline,
