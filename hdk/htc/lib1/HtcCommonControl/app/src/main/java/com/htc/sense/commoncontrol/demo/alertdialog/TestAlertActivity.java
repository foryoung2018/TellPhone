...
public class TestAlertActivity extends HtcAlertActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        mAlertParams.mTitle = getResources().getString(R.string.title_htc_alert_activity_demo);
        mAlertParams.mMessage = getResources().getString(R.string.message_htc_alert_activity_demo);
        setupAlert();
    }
