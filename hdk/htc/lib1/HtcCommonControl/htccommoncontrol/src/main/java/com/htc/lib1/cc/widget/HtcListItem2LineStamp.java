...
public class HtcListItem2LineStamp extends HtcListItem2TextComponent implements
    ...
    private HtcListItem2LineStamp(Context context, AttributeSet attrs, int defStyle, int mode ) {
    ...
    private void setDefaultTextStyle() {
        ...
        int textStyleId = a.getResourceId(R.styleable.HtcListItemAppearance_android_textAppearanceMedium,
                R.style.fixed_list_secondary);
        a.recycle();
        setPrimaryTextStyle(textStyleId);
        setSecondaryTextStyle(textStyleId);
    }
