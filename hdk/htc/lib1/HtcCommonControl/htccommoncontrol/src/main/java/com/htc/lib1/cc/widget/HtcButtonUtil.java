...
public class HtcButtonUtil {
    ...
    /**
     * Constant to indicate theme background mode.
     *
     * @hide
     */
    public static final int BACKGROUND_MODE_THEME = -1;
    ...
    /**
     * @deprecated TODO this method will be removed when remove automotive res.
     */
    ...
    private static Drawable loadSkinableResources(Context context, AttributeSet attrs, int defStyle, int index) {
        ...
        a = context.getResources().obtainTypedArray(R.array.htcbutton_drawables);

        tmp = context.getResources().getDrawable(a.getResourceId(index, 0));
