...
public class PreferenceSeparator extends HtcListItemSeparator {
     ...
     * new a PreferenceSeparator with default style.
     *
     ...
     * new a PreferenceSeparator with specified style, mode.
     *
     * @param context The Context this widget is running in, through which it
     *            can access the current theme, resources, etc.
     ...
     */
    /** @hide */
    public PreferenceSeparator(Context context, int textMode) {
     ...
     * PreferenceSeparator with default style.
     *
     * @param context The Context this widget is running in, through which it
     *            can access the current theme, resources, etc.
     ...
     */
    /** @hide */
    public PreferenceSeparator(Context context, AttributeSet attrs) {
        super(context, attrs);
        CheckUtil.isUIThread(context);
        CheckUtil.isContextThemeWrapper(context);
        init();
     ...
     */
    /** @hide */
    public PreferenceSeparator(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Constructor that is called when inflating this widget from code. It will
     * new a PreferenceSeparator with specified style, item mode, and text
     * mode.
     *
     * @param context The Context this widget is running in, through which it
     *            can access the current theme, resources, etc.
     ...
     */
    /** @hide */
    public PreferenceSeparator(Context context, int itemMode, int textMode) {
