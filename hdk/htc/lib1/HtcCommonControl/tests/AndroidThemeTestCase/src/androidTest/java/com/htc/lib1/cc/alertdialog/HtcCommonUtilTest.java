...
package com.htc.lib1.cc.alertdialog;
...
public class HtcCommonUtilTest extends HtcActivityTestCaseBase {
    ...
    private static final String DEFAULT_PATH = "/data/user/0/com.htc.home.personalize/files/.htc_theme/";
    ...
    public void testInitTheme_customPath() {
        HtcCommonUtil.initTheme(mActivity, HtcCommonUtil.BASELINE, DEFAULT_PATH);
    }
    ...
    public void testGetCommonThemeColor() {
        HtcCommonUtil.getCommonThemeColor(mActivity, com.htc.lib1.cc.R.styleable.ThemeColor_category_color);
    }
    ...
    public void testGetCommonThemeTexture_customPath() {
        HtcCommonUtil.getCommonThemeTexture(mActivity, 3, DEFAULT_PATH);
    }
