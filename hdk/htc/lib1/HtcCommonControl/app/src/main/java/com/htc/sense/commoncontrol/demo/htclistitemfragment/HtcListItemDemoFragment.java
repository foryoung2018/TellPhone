...
/**
 * Created by archermind on 15-10-19.
 */
public class HtcListItemDemoFragment extends MyFragment {
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == 0) {
                ...
                stamp.setFlagButtonOnCheckedChangeListener(new HtcListItem7Badges1LineBottomStamp.OnFlagButtonCheckedChangeListener() {
                    @Override
                ...
                badge.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Toast.makeText(mContext, "Ah-Ha", Toast.LENGTH_SHORT)
                                .show();
                    }
                });
                badge.setContentDescription(ACCESSIBILITY_CONTENT_DESCRIPTION);
