...
public class HtcRadioListWizardActivity extends HtcWizardActivity {
    ...
    private void initialize() {
        TypedArray a = obtainStyledAttributes(null, R.styleable.HtcSetupWizard, R.attr
            .htcRadioListWizardActivityStyle, R.style.HtcRadioListWizardActivityStyle);
        final int wizardLayoutId = a.getResourceId(R.styleable.HtcSetupWizard_android_layout, R
            .layout.wizard_radio_list_activity);
        final int dividerBackgroundId = a.getResourceId(R.styleable.HtcSetupWizard_android_listDivider, R
            .drawable.inset_list_divider);
        mRadioItemId = a.getResourceId(R.styleable.HtcSetupWizard_android_listViewStyle, R.layout
            .wizard_radio_listitem);
        mTextViewId = a.getResourceId(R.styleable.HtcSetupWizard_android_textAppearance, R.style
            .list_body_primary_xs);
        mDescStyleId = a.getResourceId(R.styleable.HtcSetupWizard_android_textViewStyle, R
            .style.list_body_primary_m);
        mListBackgoundId = a.getResourceId(R.styleable.HtcSetupWizard_android_background, R.drawable
            .common_app_bkg);
        a.recycle();
        setSubContentView(wizardLayoutId);
        ...
        mListDivider = findViewById(R.id.list_divider);
        ...
        mListDivider.setBackground(getResources().getDrawable(dividerBackgroundId));
        mDivider.setBackground(getResources().getDrawable(dividerBackgroundId));
        initList();
    }
    ...
    private void initList() {
        ...
        mListView.setBackground(getResources().getDrawable(mListBackgoundId));
    }
    ...
    protected void setDescriptionText(int id) {
        ...
        mText.setText(id);
        mText.setTextAppearance(this, mDescStyleId);
    }
    ...
    public void setMinorDescriptionStyle(boolean isMinorStyle) {
        ...
        mText.setTextAppearance(this, mTextViewId);
    }
