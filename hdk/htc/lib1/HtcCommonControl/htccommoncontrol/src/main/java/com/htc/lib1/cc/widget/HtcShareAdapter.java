...
public class HtcShareAdapter extends BaseAdapter {
    ...
    public HtcShareAdapter(List<Intent> intents, Set<String> allowed,
                           Set<String> blocked, Activity activity, int itemTextAppearance, boolean queryByPackage) {
        mActivity = activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null != item) {
            ...
            if (!(convertView instanceof TextView)) {
                ...
                ((TextView) convertView).setTextAppearance(mActivity, mItemTextAppearance);
            }
