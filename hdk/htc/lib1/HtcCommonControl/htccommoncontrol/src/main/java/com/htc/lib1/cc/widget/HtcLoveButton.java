...
public class HtcLoveButton extends HtcCompoundButton {
    ...
    public HtcLoveButton(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.htcLoveButtonStyle);
    }
     ...
     */
    public HtcLoveButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected int getDefStyleRes() {
        switch (mBackgroundMode) {
            default:
                return R.style.HtcCompoundButton_HtcLoveButton;
        }
    }
