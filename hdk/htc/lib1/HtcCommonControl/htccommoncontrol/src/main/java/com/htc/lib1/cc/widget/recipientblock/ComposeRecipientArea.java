...
public class ComposeRecipientArea extends LinearLayout {
    ...
    private void setConfigMode() {
        mConfigMode = getContext().getResources().getConfiguration().orientation;

        if (mConfigMode == Configuration.ORIENTATION_LANDSCAPE) { // landscape
            mIsPortMode = false;
    ...
    **/
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mConfigMode != getContext().getResources().getConfiguration().orientation) {
            setConfigMode();
