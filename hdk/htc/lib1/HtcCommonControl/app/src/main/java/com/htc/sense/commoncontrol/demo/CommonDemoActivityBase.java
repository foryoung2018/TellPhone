...
public class CommonDemoActivityBase extends Activity {
    protected int mThemeResId = CommonUtil.DEFAULT_THEME_ID;
    protected int mCategoryId = HtcCommonUtil.BASELINE;
    protected int mHeaderMode = CommonUtil.MODE_HEADER_COLOR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (shouldApplyHtcActionBar()) {
            mActionBarExt = CommonUtil.initHtcActionBar(this, shouldEnableBackup(), false, mHeaderMode);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        mThemeBundle.putInt(CommonUtil.EXTRA_HEADER_MODE_KEY, mHeaderMode);
