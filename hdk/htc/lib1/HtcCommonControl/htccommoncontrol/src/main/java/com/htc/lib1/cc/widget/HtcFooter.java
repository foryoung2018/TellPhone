...
public class HtcFooter extends ViewGroup {
    ...
    public HtcFooter(Context context, int styleMode, AttributeSet attrs, int defStyle) {
        ...
        mPortraitDefHeight = ensureIntEven(a.getDimensionPixelOffset(R.styleable.HtcFooter_android_height, 0));
        mLandScapreDefWidth = ensureIntEven(a.getDimensionPixelOffset(R.styleable.HtcFooter_android_width, 0));
        mLeftRightPadding = a.getDimensionPixelOffset(R.styleable.HtcFooter_android_thumbTextPadding, 0);
        dividerM2 = a.getDimensionPixelOffset(R.styleable.HtcFooter_android_dashGap, 0);
        a.recycle();
