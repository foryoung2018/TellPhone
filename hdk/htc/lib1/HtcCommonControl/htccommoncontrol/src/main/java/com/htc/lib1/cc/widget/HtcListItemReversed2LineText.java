...
public class HtcListItemReversed2LineText extends ViewGroup implements IHtcListItemTextComponent,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int top = secondaryTextHeight + mHtcListItemManager.getDesiredMiddleGap(mItemMode);
        if (mText[1] != null)
            mText[1].layout(0, top, width, top + primaryTextHeight);
    }
    ...
    private void setDefaultTextStyle(AttributeSet attrs) {
        TypedArray a = HtcListItemManager.obtainStyleIdSet(HtcListItem.MODE_DEFAULT, mMode, 0, getContext(), attrs);
