...
public class HtcProgressDialog extends HtcAlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            TypedArray a=getContext().obtainStyledAttributes(null, R.styleable.AlertDialog, R.attr.htcAlertDialogStyle, 0);
            final int progressDialogLayout = a.getResourceId(R.styleable.AlertDialog_android_dialogLayout, R.layout.alert_dialog_progress);
            a.recycle();
            View view = inflater.inflate(progressDialogLayout, null);
            ...
            if (!mHasTitle) {
                TypedArray a = getContext().obtainStyledAttributes(null, R.styleable.AlertDialog, R.attr.htcAlertDialogStyle, 0);
                final int layout_progress_dialog = a.getResourceId(R.styleable.AlertDialog_android_layout, R.layout.progress_dialog);
                a.recycle();
