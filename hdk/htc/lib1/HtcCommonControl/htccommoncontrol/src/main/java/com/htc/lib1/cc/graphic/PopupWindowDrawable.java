...
//        parseXML2Drawable(r, "PopupWindowDrawable", R.drawable.popupwindow_drawable, this);
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            TypedArray a = r.obtainAttributes(attrs, R.styleable.PopupWindowDrawble);
            int[] states = (a.getBoolean(R.styleable.PopupWindowDrawble_android_state_above_anchor, false))?ABOVE_ANCHOR_STATE_SET:ZERO_STATE_SET;
            int gravity = a.getInteger(R.styleable.PopupWindowDrawble_android_gravity, Gravity.TOP);
            int drawableRes = a.getResourceId(R.styleable.PopupWindowDrawble_android_drawable, 0);
            a.recycle();
