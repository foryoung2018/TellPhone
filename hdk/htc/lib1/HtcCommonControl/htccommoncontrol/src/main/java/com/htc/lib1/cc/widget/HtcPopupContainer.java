...
public class HtcPopupContainer extends FrameLayout {
    ...
    public HtcPopupContainer(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HtcPopupContainer, defThemeStyle, nStyle);
        int nShift = a.getDimensionPixelSize(R.styleable.HtcPopupContainer_android_padding, 6);
        int nMargin = a.getDimensionPixelSize(R.styleable.HtcPopupContainer_android_minHeight, 6);
        mHeightOfProgressButton = a.getDimensionPixelSize(R.styleable.HtcPopupContainer_android_layout_margin, 0);
        int nResID = a.getResourceId(R.styleable.HtcPopupContainer_android_drawable, 0);
        a.recycle();
    ...
    private void ShowAsDropDown(ViewGroup container, View anchor, int xoff, int yoff) {
        ...
        container.addView(this, new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.LEFT));
