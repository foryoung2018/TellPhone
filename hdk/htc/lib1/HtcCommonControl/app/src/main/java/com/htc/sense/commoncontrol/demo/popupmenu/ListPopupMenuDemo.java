        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (position == 0) {
                HtcListItemSeparator s = new HtcListItemSeparator(mContext,
                        HtcListItemSeparator.ITEMMODE_DEFAULT, HtcListItemSeparator.MODE_DARK_STYLE);
                s.setText(HtcListItemSeparator.TEXT_LEFT, R.string.popup_menu_separator);
                return s;
            }
            else {
                HtcListItem i;
                ...
                if (index == 0) {
                    ...
                    text.setPrimaryText(R.string.popup_menu_fling);
                    text.setSecondaryTextVisibility(View.GONE);

                } else if (index == 1) {
                    HtcListItem2LineText text = (HtcListItem2LineText) i.findViewById(R.id.text1);
                    text.setPrimaryText(R.string.popup_menu_fling1_primary);
                    text.setSecondaryText(R.string.popup_menu_fling1_secondary);

                } else if (index == 2) {
                    HtcListItem2LineText text = (HtcListItem2LineText) i.findViewById(R.id.text1);
                    text.setPrimaryText(R.string.popup_menu_fling2);
                    text.setSecondaryText(R.string.popup_menu_fling2_stamp);

                    HtcListItem2LineStamp stamp = (HtcListItem2LineStamp) i
                            .findViewById(R.id.stamp1);
                    stamp.setPrimaryText(R.string.popup_menu_fling2_exchange);
                    stamp.setSecondaryText(R.string.popup_menu_fling2_exchange);
                    ...
                    HtcListItem2LineText text = (HtcListItem2LineText) i.findViewById(R.id.text1);
                    text.setPrimaryText(R.string.popup_menu_fling3);
                    text.setSecondaryText(R.string.popup_menu_fling3_text);

                } else if (index == 4) {
                    HtcListItem2LineText text = (HtcListItem2LineText) i.findViewById(R.id.text1);
                    text.setPrimaryText(R.string.popup_menu_fling4);
                    text.setSecondaryText(R.string.popup_menu_fling4_text);
