...
public class TabReorderBuilder {
    ...
    private int mItemTextAppearance = R.style.list_primary_m;
    ...
    public View getView (int position, View convertView, ViewGroup parent) {
        ...
        if(hasCount) {
            ...
            //TODO: car mode
            count.setTextAppearance(mContext, R.style.notification_info_m);
        ...
        tv.setTextAppearance(mContext, mItemTextAppearance);
    ...
    public void setItemTextAppearance(int itemTextAppearance) {
        mItemTextAppearance = itemTextAppearance;
    }
}
