...
abstract class HtcGridItemBase extends ViewGroup {
    ...
    @ExportedProperty(category = "CommonControl")
    int mCustomImageHeight = LayoutParams.MATCH_PARENT;
    ...
    @ExportedProperty(category = "CommonControl")
    private int mDeletedOverlayColor = 0;
    @ExportedProperty(category = "CommonControl")
    ...
    public HtcGridItemBase(Context context, AttributeSet attrs, int defStyle) {
        ...
        int mode = a.getInt(R.styleable.HtcGridItem_itemMode, DEFAULT_MODE);
        mAutomotiveEnabled = (mode == AUTOMOTIVE_MODE);
        mIndicatorMarginRight = mIndicatorMarginBottom = a.getDimensionPixelOffset(R.styleable.HtcGridItem_android_indicatorRight, getResources().getDimensionPixelOffset(R.dimen.spacing));
        mDeleteIcon = a.getDrawable(R.styleable.HtcGridItem_android_drawableBottom);
        mDeletedOverlayColor = a.getColor(R.styleable.HtcGridItem_android_centerDark, getResources().getColor(R.color.HtcGridItemBase_OverlayColor));
        a.recycle();
        init();
    }
    ...
    int determineImageHeight(int imageWidth) {
        ...
        } else if (mCustomImageHeight == LayoutParams.MATCH_PARENT) {
            return imageWidth;
        } else {
            return 0;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int imageHeightMeasureSpec = (mCustomImageHeight > 0 || mCustomImageHeight == LayoutParams.MATCH_PARENT) ? MeasureSpec
