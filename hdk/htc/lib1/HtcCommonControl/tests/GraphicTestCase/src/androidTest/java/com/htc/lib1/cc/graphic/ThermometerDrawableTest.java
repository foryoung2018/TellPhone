...
public class ThermometerDrawableTest extends HtcActivityTestCaseBase {
    ...
    public final void testCurrent_sign() {
        initDrawableAndAssert(1, ThermometerDrawable.UNIT_TYPE_SIGN, com.htc.graphic.aut.R.style.weather_01, com.htc.graphic.aut.R.style.weather_02);
    }
    public final void testCurrent_celsius() {
        initDrawableAndAssert(23, ThermometerDrawable.UNIT_TYPE_CELSIUS, com.htc.graphic.aut.R.style.weather_01, com.htc.graphic.aut.R.style.weather_02);
    }
    public final void testCurrent_fahrenheit() {
        initDrawableAndAssert(456, ThermometerDrawable.UNIT_TYPE_FAHRENHEIT, com.htc.graphic.aut.R.style.weather_01, com.htc.graphic.aut.R.style.weather_02);
    }
    public final void testHigh_sign() {
        initDrawableAndAssert(7, ThermometerDrawable.UNIT_TYPE_SIGN, com.htc.graphic.aut.R.style.weather_05, com.htc.graphic.aut.R.style.weather_06);
    }
    public final void testHigh_celsius() {
        initDrawableAndAssert(89, ThermometerDrawable.UNIT_TYPE_CELSIUS, com.htc.graphic.aut.R.style.weather_05, com.htc.graphic.aut.R.style.weather_06);
    }
    public final void testHigh_fahrenheit() {
        initDrawableAndAssert(101, ThermometerDrawable.UNIT_TYPE_FAHRENHEIT, com.htc.graphic.aut.R.style.weather_05, com.htc.graphic.aut.R.style.weather_06);
    }
    public final void testLow_sign() {
        initDrawableAndAssert(987, ThermometerDrawable.UNIT_TYPE_SIGN, com.htc.graphic.aut.R.style.weather_07, com.htc.graphic.aut.R.style.weather_08);
    }
    public final void testLow_celsius() {
        initDrawableAndAssert(65, ThermometerDrawable.UNIT_TYPE_CELSIUS, com.htc.graphic.aut.R.style.weather_07, com.htc.graphic.aut.R.style.weather_08);
    }
    public final void testLow_fahrenheit() {
        initDrawableAndAssert(4, ThermometerDrawable.UNIT_TYPE_FAHRENHEIT, com.htc.graphic.aut.R.style.weather_07, com.htc.graphic.aut.R.style.weather_08);
    }
    public final void testSetBounds() {
        initDrawableAndAssert(23, ThermometerDrawable.UNIT_TYPE_CELSIUS, com.htc.graphic.aut.R.style.weather_01, com.htc.graphic.aut.R.style.weather_02, true);
    }
