...
public class HtcOverlayGridItem extends HtcGridItemBase {
    ...
    public HtcOverlayGridItem(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HtcGridItem, R.attr.htcGridItemStyle, R.style.HtcGridItemStyle);
        mIndicatorMarginBottom = a.getDimensionPixelOffset(R.styleable.HtcGridItem_android_insetTop, getResources().getDimensionPixelOffset(R.dimen.spacing));
        mPrimaryTextHorizontalMargin = a.getDimensionPixelOffset(R.styleable.HtcGridItem_android_insetLeft, getResources().getDimensionPixelOffset(R.dimen.margin_m));
        mPrimaryTextStyleResId = a.getResourceId(R.styleable.HtcGridItem_android_textAppearance, R.style.fixed_darklist_primary_xxs);
        a.recycle();
        init();
    }
