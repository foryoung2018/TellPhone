...
public class RecipientBlock extends LinearLayout {
    ...
    private void init(Context context) {
        TypedArray a = context.obtainStyledAttributes(null, R.styleable.RecipientBlock, R.attr
            .htcRecipientBlock, R.style.HtcRecipientBlockStyle);
        final int recipientId = a.getResourceId(R.styleable.RecipientBlock_android_widgetLayout, R
            .layout.compose_recipient_block);
        final int textViewStyleId=a.getResourceId(R.styleable
            .RecipientBlock_android_textViewStyle, R.style.separator_primary_m);
        final Drawable background=a.getDrawable(R.styleable.RecipientBlock_android_background);
        mTitleId = a.getResourceId(R.styleable.RecipientBlock_android_textAppearance, R.style
            .input_default_m);
        mIconId = a.getResourceId(R.styleable.RecipientBlock_android_moreIcon, R.drawable
            .icon_btn_people_light);
        a.recycle();
        LayoutInflater inflator = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflator.inflate(recipientId, this, true);
        mRecipientBlock = (LinearLayout) findViewById(R.id.compose_recipient_block);
        mRecipientBlock.setBackground(background);

        mLabelTextView = (TextView) findViewById(R.id.label);
        mLabelTextView.setAllCaps(HtcResUtil.isInAllCapsLocale(context));
        mLabelTextView.setTextAppearance(context,textViewStyleId);
    ...
    private void setupInputField(){
        ...
        mImeAutoCompleteTextView.setTextAppearance(getContext(), mTitleId);
        ...
        Drawable peopleIcon = getResources().getDrawable(mIconId);
