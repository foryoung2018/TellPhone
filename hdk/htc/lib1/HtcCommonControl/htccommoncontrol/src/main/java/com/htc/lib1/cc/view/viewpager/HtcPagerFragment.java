...
public abstract class HtcPagerFragment extends Fragment {
    ...
    /**
     * decision the interface of TabReorderFragment, user can override it to change interface
     * @return if true display ActionButton on header , otherwise display FooterTextButton on footer
     */
    ...
    public boolean startEditing() {
        if (canEdit()) {
            ...
            reorder.setActionButtonOnHeader(isActionButtonOnHeader());
