...
public class Preference2LineText extends HtcListItem2LineText {
     ...
     */
    /** @hide */
    public Preference2LineText(Context context, AttributeSet attrs) {
        super(context, attrs);
        CheckUtil.isUIThread(context);
        CheckUtil.isContextThemeWrapper(context);
        init();
     ...
     */
    /** @hide */
    public Preference2LineText(Context context, int mode) {
        super(context, mode);
        CheckUtil.isUIThread(context);
        CheckUtil.isContextThemeWrapper(context);
        init();
     ...
     */
    /** @hide */
    public Preference2LineText(Context context, AttributeSet attrs, int defStyle) {
