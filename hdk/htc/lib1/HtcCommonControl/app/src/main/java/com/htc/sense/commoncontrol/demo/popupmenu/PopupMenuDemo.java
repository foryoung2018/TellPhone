...
public class PopupMenuDemo extends CommonDemoActivityBase implements OnGlobalLayoutListener {
    ...
    private void init() {
        ...
        mListView = new HtcListView(mContext, null, com.htc.lib1.cc.R.attr.htcDropDownListViewStyle);
    ...
    private class ActionAdapter extends BaseAdapter {
        ...
        private String[] ItemStrings = getResources().getStringArray(R.array.popup_menu_demo_listitem);
