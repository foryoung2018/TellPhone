...
public class HtcListItem1LineTextProgressBar extends ViewGroup implements IHtcListItemTextComponent {
    ...
    private void setDefaultTextStyle(AttributeSet attrs) {
        ...
        int textStyleId = a.getResourceId(R.styleable.HtcListItemAppearance_android_textAppearance,
                R.style.list_primary_m);
        a.recycle();
        ((HtcFadingEdgeTextView) mText).setTextStyle(textStyleId);
    }
    ...
    private void initStamp() {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, R.styleable.HtcListItemAppearance,
                R.attr.htcListItemStyle, R.style.htcListItem);
        ...
        a.recycle();
        ((HtcFadingEdgeTextView) mStamp).setTextStyle(stampTextStyleId);
