...
import com.htc.sense.commoncontrol.demo.htclistitem.HtcListActivity;
...
public class ActionBarDemoUtil implements OnClickListener,
    ...
    private QuickContactBadge mActionBarQuickContactLeft = null;
    private QuickContactBadge mActionBarQuickContactRight = null;
    ...
    public ActionBarDropDown initActionBarDropDown() {
        ...
        mActionBarDropDown.setPrimaryText(R.string.dropdown_primary);
        mActionBarDropDown.setSecondaryText(R.string.dropdown_secondary);
    ...
    private QuickContactBadge initActionBarQuickContact() {
        QuickContactBadge abqc = new QuickContactBadge(mActivity);
        CommonUtil.wrapBorderDrawable(R.drawable.icon_category_photo, mActivity, abqc);
        abqc.assignContactFromEmail("a@b.c.com", true);
        abqc.setContentDescription(ACCESSIBILITY_CONTENT_DESCRIPTION);
        QuickContactBadgeCompat.setOverlay(abqc, null);
        final int size = mActivity.getResources().getDimensionPixelOffset(com.htc.lib1.cc.R.dimen.ab_photoframe_size);
        ActionBar.LayoutParams lp = new ActionBar.LayoutParams(size, size);
        lp.setMarginEnd(HtcResUtil.getM2(mActivity));
        lp.setMarginStart(HtcResUtil.getM2(mActivity));
        abqc.setLayoutParams(lp);
        return abqc;
    }

    public QuickContactBadge initActionBarQuickContactLeft() {
        mActionBarQuickContactLeft = initActionBarQuickContact();
        return mActionBarQuickContactLeft;
    }

    public QuickContactBadge initActionBarQuickContactRight() {
    ...
    public ActionBarText initActionBarText() {
        ...
        mActionBarText.setPrimaryText(R.string.actionbar_text_primary);
        mActionBarText.setSecondaryText(R.string.actionbar_text_secondary);
