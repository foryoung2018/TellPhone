...
public class StyledAndroidDialogDemo extends CommonDemoActivityBase {
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        int themeId = (mThemeMode == 0) ? R.style.HtcAlertDialogTheme : R.style.HtcAlertDialogTheme_Dark;
        switch (id) {
            case 4:
                // progress dialog "Android style"
                final ProgressDialog qDialog = new ProgressDialog(this, themeId);
                ...
                qDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                    @Override
                    public void onShow(DialogInterface dialog) {
                        TextView message = (TextView) qDialog.findViewById(android.R.id.message);
            ...
            case 3:
                ...
                final ProgressDialog pDialog = new ProgressDialog(this, themeId);
...
//                data.add(tmp);
                ...
                View phone = getLayoutInflater().inflate(R.layout.phone_options_item, null);
                TextView action = (TextView) phone.findViewById(R.id.action);
                TextView dec = (TextView) phone.findViewById(R.id.description);
                action.setTextAppearance(this, (mThemeMode == 0) ? R.style.list_primary_m : R
                    .style.darklist_primary_m);
                dec.setTextAppearance(this, (mThemeMode == 0) ? R.style.list_secondary_m : R
                    .style.darklist_secondary_m);
                return new AlertDialog.Builder(this, themeId)
            ...
            case 1112:
                ...
                CheckBox checkBox = (CheckBox) checkView.findViewById(R.id.checkBox);
                textView.setTextAppearance(this, (mThemeMode == 0) ? R.style.list_body_primary_m : R
                    .style.darklist_body_primary_m);
                checkBox.setTextAppearance(this, (mThemeMode == 0) ? R.style.fixed_list_secondary_m : R
                    .style.fixed_darklist_secondary_m);
                return new AlertDialog.Builder(this, themeId)
                        .setTitle("存取要求")
...
//                        .setCustomTitle(customTitle)
                AlertDialog ret = new AlertDialog.Builder(this, themeId)
